...
internals.pathCheck = async function(pathCache, request) {
...
internals.userCheck = async function(userCache, request) {
    const plugin = request.plugins[internals.pluginName];
    const settings = plugin.requestSettings;
...
internals.userPathCheck = async function(userPathCache, request) {
    const plugin = request.plugins[internals.pluginName];
    const settings = plugin.requestSettings;
    const ip = internals.getIP(request, settings);
    let user = internals.getUser(request, settings);
